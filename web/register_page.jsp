<%-- 
    ...
    Created on : 12.Ara.2018, 17:40:53
    Author     : yakup
--%>
                            ...
                            <div class="container">
                                <div class="row main">
                                    <div class="main-login main-center">
                                        <h5>Ücretsiz kayıt olun ve makalelerinizi yükleyin.</h5>
                                        <form method="POST" action="kullaniciEkle">
                                            ...
                                            <div class="form-group">
                                                <label for="email" class="cols-sm-2 control-label">E-Posta</label>
                                                <div class="cols-sm-10">
                                                    <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="cols-sm-10">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                                        <input type="password" class="form-control" name="confirm" id="confirm"  placeholder="Şifrenizi Tekrar Girin"/>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="form-group ">
                                                <input type="submit" id="button" class="btn btn-primary btn-lg btn-block login-button" value="Kayıt Ol"/>
                                            </div>
