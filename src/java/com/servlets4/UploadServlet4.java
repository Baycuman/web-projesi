...
@WebServlet(name = "UploadServlet4", urlPatterns = {"/UploadServlet4"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                String sql = "insert into hakemred(firstname,lastname,filename,path,added_date) values(?,?,?,?,?)";
