<%-- 
    Document   : onaylananmakale
    Created on : 25.Ara.2018, 17:01:31
    Author     : yakup
--%>
                                ...
                                <input type="text" size="30" required="" name="firstname">
                                    ...
                                    <input type="text" size="30" required="" name="lastname">
                                        ...
                                        <input type="file" required="" name="file">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><input type="submit" value="MAKALEYİ ONAYLA"></td>
                                                </tr>
                                                </table>

                                                </form>
                                                <br><a href = "editoronaymakale.jsp"><font color="GREEN"><strong>ONAYLANANLARI GÖRÜNTÜLE</strong></a>
                                                </center>
