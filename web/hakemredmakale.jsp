<%-- 
    Document   : hakemredmakale
    Created on : 25.Ara.2018, 19:36:11
    Author     : yakup
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <p><font face="tahoma" size="6" color="white">
                        <b>YAYINLANMASI UYGUN GÖRÜLMEYEN MAKALELER</b></font></p>
            ...
            <center>
                ...
                <table border="2">
                    ...
                    <tr>
                        ...
                        <td><a href="DownloadServlet4?fileName=<%=rs.getString(4)%>">Download</a></td>
                    </tr>
                    <%
                        }
                    %>
