<%-- 
    Document   : editorredmakale
    Created on : 23.Ara.2018, 01:42:16
    Author     : yakup
--%>
                ...
                <div class="header">
                    ...
                    <div class="header-right"> 
                        ...
                        <p><font face="tahoma" size="7" color="white">
                            <b>Reddedilen Makaleler</b></font></p>
                        <div class="blog-user">
                    ...
                    <table border="2">
                        ...
                        <tr>
                            ...
                            <td><a href="DownloadServlet3?fileName=<%=rs.getString(4)%>">Download</a></td>
                        </tr>
                        <%
                            }
                        %>
